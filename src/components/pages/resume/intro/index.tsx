    ...
    <>
      <ResumeIntroWrapper>
        <section className='resumeIntro1'>
          ...
          <img src='https://static.wanted.co.kr/images/userweb/resume_intro/resume_01_en.png' alt='문서이미지' />
        </section>
        ...
        <section className='resumeIntro3'>
          ...
          <img src='https://static.wanted.co.kr/images/userweb/resume_intro/resume_03_ko.png' alt='태블릿이미지' />
        </section>
